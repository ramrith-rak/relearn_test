  ...
  const contactInfo = [
    {
      ...
      title: "Email",
      content: "hello@techflow.dev",
      link: "mailto:hello@techflow.dev"
    },
    {
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-muted-foreground leading-relaxed mb-8">
                ...
                possibilities, we'd love to hear from you. Our team is here to help 
                you navigate the digital landscape and create solutions that drive results.
              </p>
            </div>
            ...
            <div className="space-y-6">
              {contactInfo.map((info, index) => (
                <Card 
                  key={index} 
                  className="p-6 bg-gradient-card border-border/50 hover:shadow-elegant transition-shadow"
                >
            ...
            <div className="pt-8">
              <h4 className="font-semibold text-foreground mb-4">Why Choose TechFlow?</h4>
